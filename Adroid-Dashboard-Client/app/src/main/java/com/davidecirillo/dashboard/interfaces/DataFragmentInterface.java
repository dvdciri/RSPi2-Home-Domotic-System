...
*/
public interface DataFragmentInterface extends BaseViewInterface {

    void onNewControl(ControlSnapshot controlSnapshot, boolean shouldClearList);

    void onActionResult(String message);
}
